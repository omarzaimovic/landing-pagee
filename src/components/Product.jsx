...
const rows = [
  ...
  createData("Ice cream sandwich", 237, 9.0, 37, 4.3, "101"),
  createData("Eclair", 262, 16.0, 24, 6.0, "102"),
  createData("Cupcake", 305, 3.7, 67, 4.3, "103"),
  createData("Gingerbread", 356, 16.0, 49, 3.9, "104"),
];
